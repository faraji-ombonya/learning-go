...
func main() {
	...
	// Printing a map with e.g. fmt.Println will show all of its key/value
	// pairs.
	fmt.Println("map:", m)
	...
	// If the key doesn't exist, the zero value of the type is returned.
	v3 := m["k3"]
	fmt.Println("V3", v3)
	...
	// disambuguate between missing keys and keys with zero values like 0 or ""
