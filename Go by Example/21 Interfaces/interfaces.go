...
// Sometimes it's useful to know the runtime type of an interface value. One
// option is using a type assertion as shown here; another is a type switch
...
func main() {
	...
	// The circle and the rect struct types both implement the geometry
	// interface so we can use instances of these atructs as arguments to
	// measure
	measure(r)
	measure(c)
