...
// zerolval and zeroptr. zeroval has an int paremeter, so arguments will be
...
// pointer. The *ptr code in the function body then dereferences the pointer
...
// zero val doesn't change the i in main, but zeroptr does because it has a
